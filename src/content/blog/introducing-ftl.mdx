...
FTL is still in early development and I'll have to build disk support, efficient copy-on-write `fork(2)`, `/proc` filesystem, TTY support, and more. That being said, this toy started working and is already fun to play with.
