...
## Why people don't use microkernels
...
**Lesson: Microkernel OS security depends on how people implement userland.**

### OS development is painful and scary
...
### Don't emulate everything: use real Linux in microVM
