...
export async function renderMDX(source: string) {
    const { content, frontmatter, scope, error } = await evaluate<Frontmatter, Scope>({
        ...
        components: {
            ...
            h2: (props) => <h2 className="text-3xl mt-16 mb-4 pb-2 font-bold">{props.children}</h2>,
            ...
            p: (props) => <p className=" text-pretty text-base leading-relaxed mb-6 max-w-prose">{props.children}</p>,
