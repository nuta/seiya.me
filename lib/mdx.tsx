...
export async function renderMDX(source: string) {
  ...
  >({
    ...
    components: {
      ...
      h3: (props) => (
        <h3 className="font-sans text-xl font-semibold mt-10 mb-4">
          {props.children}
        </h3>
      ),
      h4: (props) => (
        <h4 className="font-sans text-lg font-semibold mt-8 mb-3">
          {props.children}
        </h4>
      ),
      h5: (props) => (
        <h5 className="font-sans text-lg font-semibold mt-6 mb-2">
          {props.children}
        </h5>
      ),
      p: (props) => (
      ...
      code: (props) => (
        <code className="font-mono text-[92%]">{props.children}</code>
      ),
      pre: (props) => (
        <pre className="my-6 px-4 py-4 text-slate-200 bg-slate-900 leading-5 rounded-lg overflow-x-auto border border-slate-700">
          {props.children}
        </pre>
      ),
      ul: (props) => (
        <ul className="list-disc pl-6 text-base mb-5 space-y-2">
          {props.children}
        </ul>
      ),
      ol: (props) => (
        <ol className="list-decimal pl-6 text-base mb-5 space-y-2">
          {props.children}
        </ol>
      ),
      strong: (props) => (
      ...
      blockquote: (props) => (
        <blockquote className="text-base mb-6 border-l-4 border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 pl-6 italic py-2">
          {props.children}
        </blockquote>
      ),
      hr: (props) => (
