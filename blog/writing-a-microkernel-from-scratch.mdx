...
![さくらのクラウドで元気に動く作ったOS](/media/writing-a-microkernel-from-scratch/resea-on-sakura-cloud.png)
...
## 設計
![Reseaのざっくりした仕組み](/media/writing-a-microkernel-from-scratch/resea-architecture.png)
...
![さくらのクラウドで元気に動いている様子（再掲）](/media/writing-a-microkernel-from-scratch/resea-on-sakura-cloud.png)
...
### Wireshark
![Wiresharkで見るメッセージパッシング](/media/writing-a-microkernel-from-scratch/wireshark-for-resea.png)
