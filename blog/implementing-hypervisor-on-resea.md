...
![デモ: 実機（Intel NUC）のResea上で動くLinux](/media/implementing-hypervisor-on-resea/linux-on-hv.jpg)
...
![KVMの概要](/media/implementing-hypervisor-on-resea/kvm-architecture.png)
...
![hvの概要。基本的な仕組みはKVMと大して変わらない](/media/implementing-hypervisor-on-resea/resea-hv-architecture.png)
