...
I've recently added a Linux compatibility layer to [Starina operating system](https://github.com/starina-os/starina) based on a lightweight VM approach similar to WSL2.
